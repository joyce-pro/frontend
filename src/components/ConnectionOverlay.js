...
export default function ConnectionOverlay({ isOpen, onClose, children, result }) {
    ...
    const handleClick = async () => {
        try {
            const response = await fetch(`${baseUrl}/connection/create/`, {
                method: "POST",
                headers: {
                ...
                <div id="outreachModal" className="fixed inset-0 flex justify-center items-center">
                    <div className="bg-white p-8 rounded-lg w-[700px] max-h-[750px] overflow-y-auto">
                        ...
                        <label htmlFor="campaignName" className="block text-gray-700 font-semibold mb-2">
                            Outreach Connection Campaign Name
                        </label>
                        <input
                            id="campaignName"
                            type="text"
                            ...
                            placeholder="Enter connection campaign name"
                        />
